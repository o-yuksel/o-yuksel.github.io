...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/pathway.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Konieczkowski DJ, Johannessen CM, Garraway LA. A Convergence-Based Framework for Cancer Drug Resistance. Cancer Cell. 2018 May 14;33(5):801-815.
</div>
...
Here is an example: EGFR-mutated NSCLC with osimertinib, followed by histologic transformation to SCLC, and ultimately incorporating chemotherapy and its corresponding evolution of resistance.
